---
title: Rules
description: Sidekit rules
---

## Presets
### sidekit:recommended
- [sidekit:sidekit:documentation](#sidekitsidekit:documentation)
- [sidekit:sidekit:automation](#sidekitsidekit:automation)
## Rules
### sidekit:automation
Enforce the AI to check for available rules when installing new dependencies.
````mdx
## Sidekit setup
