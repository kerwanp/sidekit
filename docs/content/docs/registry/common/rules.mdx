...
## Presets
## Rules
### common:commit-conventional
Enforce agent to commit changes using conventional commits
````mdx
## Commit worfklow
...
````
### common:commit-gitmoji
Enforce agent to commit changes using gitmoji convention
````mdx
## Commit worfklow
